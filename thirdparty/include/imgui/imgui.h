...
struct ImDrawList
{
    ...
    IMGUI_API void  AddTextOutline( const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end, float alpha );
...
struct ImFontConfig
{
    ...
    void AddTextOutline( const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end, float alpha );
