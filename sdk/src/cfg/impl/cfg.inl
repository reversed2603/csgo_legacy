...
namespace sdk {
	...
	ALWAYS_INLINE cfg_var_t< _value_t >::cfg_var_t ( const std::size_t hash, const _value_t value )
	...
	template < typename _value_t >
	ALWAYS_INLINE _value_t& cfg_var_t< _value_t >::value ( ) { return m_value; }

	template < typename _value_t >
	ALWAYS_INLINE const _value_t& cfg_var_t< _value_t >::value ( ) const { return m_value; }
	...
	ALWAYS_INLINE detail::base_cfg_var_t* c_cfg::find_var ( const std::size_t hash ) const
	{
