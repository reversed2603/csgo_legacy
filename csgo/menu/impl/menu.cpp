...
void draw_visuals( ) {
    ...
    if( visual_sub_tab == 0 ) {
        ...
        ImGui::ColorEdit4( xor_str( "local trace clr" ), cfg.m_bullet_tracers_clr, ImGuiColorEditFlags_NoTooltip | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaBar );
