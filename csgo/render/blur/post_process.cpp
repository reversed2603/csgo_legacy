...
#else
        blurShaderX.init( 
#include "shaders/blur_x.glsl"
            ,
#include "shaders/passthrough.glsl"
        );

        blurShaderY.init( 
#include "shaders/blur_y.glsl"
            ,
#include "shaders/passthrough.glsl"
        );
#endif
...
#else
        shader.init( 
#include "shaders/monochrome.glsl"
            ,
#include "shaders/passthrough.glsl"
        );
#endif
...
{
    blur_effect::draws( drawList, p_min, p_max, alpha );
}
